      ...
      return(
        <div className={classes.root}>
            <Button variant="contained" 
              ...
              className={classes.newChatBtn} style={{backgroundColor:"#1f3f81",height: "50px"}}>
                nouveau Message  <Icon className="fa fa-plus-circle"style={{ color: "white",width:"46px" }} />
            </Button>
            <List>
              {
                  ...
                  return (
                    <div key={_index}>
                      <ListItem onClick={() => this.selectChat(_index)} 
                        ...
                        <ListItemAvatar>
                          <Avatar alt="Remy Sharp">{_chat.users.filter(_user => _user !== this.props.userEmail)[0]}</Avatar>
                        </ListItemAvatar>
                        <ListItemText 
