...
class FormulaireEtude extends Component {
    ...
    render() {
        return ( <
            ...
            FormFeedback style = {
                { color: "red" } }
            invalid = {!this.validator.fieldValid('  email ') } > { this.validator.message('email', this.state.email, 'required|email') } 
            </FormFeedback>
            ...
            onSubmit = { this.onSubmit } >
             ...
             <div className = "form-group" >
              <select
              valid = { this.validator.fieldValid('Statut') }
              invalid = {!this.validator.fieldValid('Statut ') }
               name="statut" value={this.state.statut} onChange={this.onChange}
              style={{    width: "601px", backgroundColor: "transparent", fontSize: "18px", color: "white"}}>
                <option className="active">
                            Choisir un le statut de votre projet
                </option>
                          <option className="active" value="vente" style={{color:"black"}}>
                           Vente
                          </option>
                          <option className="active" value="achat" style={{color:"black"}}>
                          Achat
                          </option>
                           <option className="active" value="location" style={{color:"black"}}>
                           Location
                          </option>
                          <option className="active" value="autres" style={{color:"black"}}>
                           Autres
                          </option>
                        </select>
                         <FormFeedback style = {
            ...
            <div className = "form-group" >
            <input 
             valid = { this.validator.fieldValid('Budget') }
            ...
            <div className = "form-group" >
              ...
              <select
                          ...
                          onChange={this.onChange}
                          style={{    width: "601px", backgroundColor: "transparent", fontSize: "18px",
                    color: "white"}}
                        >
                          <option style={{ fontSize: "18px",
                   }} >Localisation</option>
                          {villes.map((el, i) => (
                            <option key={i} value={el} style={{color:"black"}}>
                              {el}
                            </option>
                          ))}
                        </select>
...
<h3  style = {
                { color: "black",marginTop: "36px", marginLeft:'4px'}}>il faut que vous choisissiez un agent pour qu'il traite votre demande</h3>
            <h4 style = {
                { color: "black",    marginRight: "277px",
   
    marginTop: "20px",
    marginBottom: "-77px",
        marginLeft: "11px" } } > Non d 'agent :</h4> 
    <div className = "form-group" >
    ...
    width: "376px"}}
            ...
            onClick = {
                () => this.closeModal() } > < button type = "button"
            className = "btn btn-primary"
            style = {
                { marginTop: " 18px", width: "162px", height: "50px", backgroundColor: "#1f3f81" } } > Fermer 
                </button>
                </a >
            </div> 
            </Modal>
